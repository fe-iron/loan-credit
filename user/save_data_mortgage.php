...
if(isset($_POST['s'])){
        ...
        if( in_array($imageFileType1,$extensions_arr) ){
            ...
            if(move_uploaded_file($_FILES['photo']['tmp_name'],$target_dir.$photo)){
             ...
             header("Location: mortgage.php?result=Something went wrong! at ".$photo);
         }
        ...
        if($occupation == 'salaried'){
            ...
            if(move_uploaded_file($_FILES['salary_slip']['tmp_name'],$target_dir.$salary_slip)){
                ...
                header("Location: mortgage.php?result=Something went wrong! at ".$salary_slip);
            }
            ...
            if(move_uploaded_file($_FILES['form16']['tmp_name'],$target_dir.$form16)){
                ...
                header("Location: mortgage.php?result=Something went wrong! at ".$form16);
            }
            ...
            if(move_uploaded_file($_FILES['joining_letter']['tmp_name'],$target_dir.$joining_letter)){
                ...
                header("Location: mortgage.php?result=Something went wrong! at ".$joining_letter);
            }
            ...
            if(move_uploaded_file($_FILES['identity']['tmp_name'],$target_dir.$identity)){
                ...
                header("Location: mortgage.php?result=Something went wrong! at ".$identity);
            }
            ...
            if(move_uploaded_file($_FILES['bank_statement']['tmp_name'],$target_dir.$bank_statement)){
                ...
                header("Location: mortgage.php?result=Something went wrong! at ".$bank_statement);
            }
            ...
            if(move_uploaded_file($_FILES['trade']['tmp_name'],$target_dir.$trade)){
                ...
                header("Location: mortgage.php?result=Something went wrong! at ".$trade);
            }
            ...
            if(move_uploaded_file($_FILES['itr']['tmp_name'],$target_dir.$itr)){
                ...
                header("Location: mortgage.php?result=Something went wrong! at ".$itr);
            }
            ...
            if(move_uploaded_file($_FILES['gst']['tmp_name'],$target_dir.$gst)){
                ...
                header("Location: mortgage.php?result=Something went wrong! at ".$gst);
            }
        ...
        if(!empty($_FILES['previous_loan_sanction']['name'])){
            ...
            if(move_uploaded_file($_FILES['previous_loan_sanction']['tmp_name'],$target_dir.$previous_loan_sanction)){
                ...
                header("Location: mortgage.php?result=Something went wrong! at ".$previous_loan_sanction);
            }
        }else{
        ...
        if(!empty($_FILES['current_statement']['name'])){
            ...
            if(move_uploaded_file($_FILES['current_statement']['tmp_name'],$target_dir.$current_statement)){
                ...
                header("Location: mortgage.php?result=Something went wrong! at ".$current_statement);
            }
        }else{
            $current_statement = '';
        }
        ...
        if(in_array($imageFileType12,$extensions_arr)){
           ...
           if(move_uploaded_file($_FILES['deed']['tmp_name'],$target_dir.$deed)){
            ...
            header("Location: mortgage.php?result=Something went wrong! at ".$deed);
        }
        ...
        if(in_array($imageFileType13,$extensions_arr)){
           ...
           if(move_uploaded_file($_FILES['chain_deed']['tmp_name'],$target_dir.$chain_deed)){
            ...
            header("Location: mortgage.php?result=Something went wrong! at ".$chain_deed);
        }
        ...
        if(in_array($imageFileType14,$extensions_arr)){
           ...
           if(move_uploaded_file($_FILES['update_parcha']['tmp_name'],$target_dir.$update_parcha)){
            ...
            header("Location: mortgage.php?result=Something went wrong! at ".$update_parcha);
        }
        ...
        if(in_array($imageFileType15,$extensions_arr)){
           ...
           if(move_uploaded_file($_FILES['update_khajna']['tmp_name'],$target_dir.$update_Khajna)){
            ...
            header("Location: mortgage.php?result=Something went wrong! at ".$update_khajna);
        }
        ...
        if($occupation == "salaried"){
            if($flag1 && $flag4 && $flag5 && $flag6 && $flag7 && $flag8
                ...
                $query = "INSERT INTO loans (phone_number,loan,photo,salary_slip,form_16,joining_letter,deed,chain_deed,update_parcha,update_khajna,sanctioned_plan,previous_loan,current_statement,loan_type)
                    values('$phone', '$occupation', '$photo', '$salary_slip', '$form16', '$joining_letter', '$deed', '$chain_deed', '$update_parcha', '$update_Khajna', '$sanctioned_plan', '$previous_loan_sanction', '$current_statement', 'Mortgage Loan')";
                // echo $query;
                    ...
                    if($result){
                     ...
                     header("Location: payment.php?result=".$msg);      
                        ...
                        $msg = "Update Failed!";
                        header("Location: mortgage.php?result=".$msg);
                    }
            ...
            if($flag1 && $flag2 && $flag3 && $flag7 && $flag8 && $flag9 && $flag10 
                ...
                $query = "INSERT INTO loans (phone_number,loan,identity,bank_statement,trade_licence,itr,gst,photo,deed,chain_deed,update_parcha,update_khajna,sanctioned_plan,previous_loan,current_statement,loan_type)
                    values('$phone', '$occupation', '$identity', '$bank_statement', '$trade', '$itr', '$gst', '$photo', '$deed', '$chain_deed', '$update_parcha', '$update_Khajna', '$sanctioned_plan', '$previous_loan_sanction', '$current_statement', 'Mortgage Loan')";
