                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="super_admin.php">
                        ...
                        <b class="logo-icon">
                            ...
                            <img src="../images/eazycreditsolution.png"  style="width: 200px; height: 50px;" alt="homepage" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                    </a>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item pt-2 common_btn">
                            <a class="sidebar-link" href="super_admin.php"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item common_btn">
                            <a class="sidebar-link" href="common_number.php"
                                aria-expanded="false">
                                <i class=" fas fa-edit" aria-hidden="true"></i>
                        ...
                        <li class="sidebar-item common_btn">
                            <a class="sidebar-link" href="upload_images.php"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item common_btn">
                            <a class="sidebar-link" href="result_out.php"
                                aria-expanded="false">
